function calcShipping(sum, min, shipping) {
    ...
    if (productsSum == 0) {
        shippingSum = 0;
        console.log('Корзина пуста, доставка не учитывается');
    } else {
        console.log('Стоимость доставки 0');
    }
    // если productsSum Больше или равна freeShippingMinSum,
    // то shippingSum присвоить значение 0
    if (productsSum >= freeShippingMinSum) {
        shippingSum = 0;
        console.log('Сумма продуктов дороже доставки');
    } else {
    ...
    if (productsSum > 0 && productsSum < freeShippingMinSum) {
        ...
        console.log('Сумма продуктов недостаточна для бесплатной доставки');
    } else {
        console.log('Стоимость доставки добавлена к заказу');
    }
...
function calcDiscount(sum, min, discount) {
    ...
    if (productsSum >= discountMinSum) {
        ...
        console.log ("скидка учтена")
    } else { discountSum = 0;
    console.log ('сумма скидки равна 0')
    }
